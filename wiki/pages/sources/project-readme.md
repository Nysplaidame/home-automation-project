...
virtualisation, Home Assistant, docker-host services, and OMV-backed storage.
Canonical docs now use the fresh rebuild manual under `main/docs/install/`; old
prompt-era dashboards and sub-project prompts have been removed.
...
- [[entities/frigate]] runs on VM 101 at 192.168.30.20
- [[entities/docker-host]] runs on VM 103 at 192.168.20.102 and hosts Bambuddy plus future Tier 1 services
