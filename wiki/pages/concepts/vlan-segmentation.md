---
title: "11-Segment Network Segmentation"
category: concept
...
# 11-Segment Network Segmentation

## Definition

A network architecture that divides devices into 11 isolated Layer 2 broadcast
...
The 11-segment design is the security foundation for the home automation system.
...
| 55 | Cloud IoT | 192.168.55.0/24 | WAN only | Hive hub on router LAN2 |
...
- **CCTV switch access standard:** Zyxel port 1 is the router trunk, ports 2-7
  ...
  spare storage access port; OMV is directly on router LAN4.
...
- VLAN55 -> WAN: allowed; no internal forwarding. Router input limited to
  DHCP/DNS/NTP. Hive app/account acceptance remains open despite verified
  internet traffic. See [[../../../main/docs/reference/current-live-state]].
...
- 2026-09-04: Added cloud IoT VLAN55 for Hive, bringing the design to 11 segments.
