...
Verified 2026-06-20. Use `qm config` for VMs and `pct config` for LXCs.

| ID | Kind | Name | VLAN/IP | CPU/RAM/Disk | Startup | State |
|---:|---|---|---|---|---|---|
| 100 | VM | home-assistant | 20 / 192.168.20.101 | 2c / 4 GiB / 32 GiB | order 1, onboot | live |
| 101 | VM | frigate-nvr | disconnected rollback identity | 2c / 4 GiB / 64 GiB | off | rollback only |
| 102 | VM | monitoring | 60 / 192.168.60.10 | 2c / 2 GiB / 32 GiB | order 3, onboot | live |
| 103 | VM | docker-host | 20 / 192.168.20.102 | live config is authoritative | onboot | live |
| 104 | VM | llm-host | disconnected rollback identity | 4c / 10 GiB / 160 GiB | off | rollback only |
| 111 | LXC | frigate-nvr | 30 / 192.168.30.20 | 2c / 4 GiB / 32 GiB | order 2, onboot | live |
| 114 | LXC | llm-host | 20 / 192.168.20.104 | 4c / 10 GiB / 100 GiB | order 4, onboot | live |
