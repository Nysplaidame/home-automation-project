(() => {
  ...
  const PREVIEW_PROXY_PORTS = new Map([
    ...
    ['192.168.40.50', 8187],
    ['192.168.20.101:8123', 8188],
    ['192.168.20.102:2283', 8189],
    ['192.168.20.102:5984', 8190],
    ['192.168.20.102:8080', 8191],
    ['192.168.20.102:8081', 8192],
    ['192.168.20.102:8085', 8193],
    ['192.168.20.102:8087', 8194],
    ['192.168.20.102:8092', 8195],
    ['192.168.20.102:8093', 8196],
    ['192.168.20.102:8100', 8197],
    ['192.168.20.102:9283', 8198],
    ['192.168.20.102:9925', 8199],
    ['192.168.20.104:3002', 8200],
    ['192.168.40.50:8088', 8201],
  ...
  function getFrameHref(href) {
    try {
      ...
      if (!port) return href;
      return `https://${window.location.hostname}:${port}${url.pathname}${url.search}${url.hash}`;
    } catch {
      return href;
    }
  }
