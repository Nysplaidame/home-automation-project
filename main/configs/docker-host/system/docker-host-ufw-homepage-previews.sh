...
"$UFW_BIN" allow from 192.168.10.0/24 to any port 8180:8204 proto tcp comment "Management to Homepage previews" >/dev/null
"$UFW_BIN" allow from 192.168.1.0/24 to any port 8180:8204 proto tcp comment "LAN to Homepage previews" >/dev/null
"$UFW_BIN" allow from 192.168.20.0/24 to any port 8180:8204 proto tcp comment "Automation to Homepage previews" >/dev/null
"$UFW_BIN" allow in on tailscale0 to any port 8180:8204 proto tcp comment "Tailscale Homepage previews" >/dev/null
