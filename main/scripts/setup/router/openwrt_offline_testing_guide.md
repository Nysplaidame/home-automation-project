...
- Docker host: 192.168.20.102 (outside DHCP range 110-149)
...
ping 9.9.9.9          # Should FAIL (no internet)
```
...
- HA → Printers: TRUST-BOUNDARY NOTE (Docker host and HA are same-subnet on VLAN 20)
