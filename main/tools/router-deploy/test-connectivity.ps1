...
foreach ($dnsName in @("homeassistant.home.local", "docker-host.home.local", "bambuddy.home.local", "adguard.home.local", "immich.home.local", "homepage.home.local", "dozzle.home.local", "nas.home.local", "omv.home.local", "omv-nas.home.local", "frigate.home.local")) {
    $dnsCmd = @"
