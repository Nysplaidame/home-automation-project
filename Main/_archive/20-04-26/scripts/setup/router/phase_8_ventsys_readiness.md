...
echo "Available devices: proxmox-host, home-assistant, frigate-nvr, pi-nas, ventsys-main-fan, ventsys-sla-print-valve  # A6-1 fix: was ventsys-fan-controller, ventsys-valve-controller (stale names)"
    exit 1
fi
