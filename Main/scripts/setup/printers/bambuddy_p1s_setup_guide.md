...
guide. Use the dedicated Bambuddy VM guide instead.

## Current Architecture

| Component | Current value |
|---|---|
| Bambuddy host | VM 103, `192.168.20.102`, VLAN 20 |
...
| Canonical deployment guide | `scripts/setup/proxmox/bambuddy_vm_setup_guide.md` |

## Operator Checklist

1. Follow `scripts/setup/proxmox/bambuddy_vm_setup_guide.md` to create VM 103
   and deploy Bambuddy.
...
If these checks pass, continue in the canonical VM 103 guide.
