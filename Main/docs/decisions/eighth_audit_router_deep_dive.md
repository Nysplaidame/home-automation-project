...
Bambuddy moved to the VLAN 20 Docker host VM 103, P1S moved to 192.168.35.200.
...
192.168.35.200 or Athena 2 at 192.168.35.201. No reservation for VM 103 (Docker host)
...
Docker host (20.102). Update P1S reservation from 192.168.1.200 → 192.168.35.200.
...
- **dhcp-config.conf** — v2.0 dated 2026-04-10, 10 VLAN scopes, VLAN 35 scope
  correct, P1S at 192.168.35.200, Athena 2 at 192.168.35.201, docker-host at
