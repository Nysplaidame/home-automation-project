...
- **Archived snapshot** - this diagram is retained as a legacy 4-VLAN reference.
- **Current architecture** - use [[docs/decisions/02-printer-vlan-architecture]] and `tools/router-deploy/README.md`.
- **Router setup** - first-flight 10-segment config was deployed and smoke-tested on 2026-05-07.

**Next Implementation:** Proxmox trunk validation on GL-MT6000 `lan1`.
